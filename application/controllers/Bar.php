...
class Bar extends CI_Controller {
    ...
    public function update_cooking_status_ajax()
    {
        ...
        // $bar_type_items_in_one_order = $this->Bar_model->get_total_bar_type_items($sale_id);
        // $bar_type_items_done = $this->Bar_model->get_total_bar_type_done_items($sale_id);
        // $bar_type_items_started = $this->Bar_model->get_total_bar_type_started_cooking_items($sale_id);
        
        // $progressed_items = $bar_type_items_done+$bar_type_items_started;        
