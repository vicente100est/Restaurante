        ...
        <div class="col-lg-7">
          ...
          <div class="box-body">  
            <div style="width: 33%; float: left; height: 260px;">
              <a class="btn icon-btn btn-info" style="background-color: #02205F;" href="<?php echo base_url(); ?>Master/addEditFoodMenu"><span class="fa fa-book text-info"></span>+ <?php echo lang('food_menu'); ?></a>
              ...
              <a class="btn icon-btn btn-info" style="background-color: #7600FF;" href="<?php echo base_url(); ?>Sale/POS"><span class="fa fa-television text-info"></span><?php echo lang('pos'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #DD4B39;" href="<?php echo base_url(); ?>Expense/addEditExpense"><span class="fa fa-money text-info"></span>+ <?php echo lang('expense'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #FF2E4D;" href="<?php echo base_url(); ?>Purchase/addEditPurchase"><span class="fa fa-truck text-info"></span>+ <?php echo lang('purchase'); ?></a>
            </div>
            <div style="width: 33%; float: left; height: 260px;">
              <a class="btn icon-btn btn-info" style="background-color: #006EFF;" href="<?php echo base_url(); ?>Report/dailySummaryReport"><span class="fa fa-list text-info"></span><?php echo lang('daily_summary_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #957CB8;" href="<?php echo base_url(); ?>Report/registerReport"><span class="fa fa-list text-info"></span><?php echo lang('register_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #6F61AA;" href="<?php echo base_url(); ?>Report/profitLossReport"><span class="fa fa-list text-info"></span><?php echo lang('profit_loss_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #00A894;" href="<?php echo base_url(); ?>Report/saleReportByDate"><span class="fa fa-list text-info"></span><?php echo lang('sales_report'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #cc998d;" href="<?php echo base_url(); ?>Report/foodMenuSales"><span class="fa fa-list text-info"></span><?php echo lang('food_sales_report'); ?></a>              
            </div>
            <div style="width: 33%; float: left; height: 260px;">
              <a class="btn icon-btn btn-info" style="background-color: #0c1713;" href="<?php echo base_url(); ?>Short_message_service/smsService"><span class="fa fa-envelope text-info"></span><?php echo lang('send_sms'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #700353;" href="<?php echo base_url(); ?>Inventory/index"><span class="fa fa-cube text-info"></span><?php echo lang('inventory'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #4c1c00;" href="<?php echo base_url(); ?>Inventory_adjustment/inventoryAdjustments"><span class="fa fa-adjust text-info"></span><?php echo lang('inventory_adjustment'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #00A65A;" href="<?php echo base_url(); ?>Customer_due_receive/customerDueReceives"><span class="fa fa-users text-info"></span>+ <?php echo lang('customer_receive'); ?></a>
              <a class="btn icon-btn btn-info" style="background-color: #0c5889;" href="<?php echo base_url(); ?>Attendance/addEditAttendance"><span class="fa fa-clock-o text-info"></span>+ <?php echo lang('attendance'); ?></a>
            </div>             
          </div> 
        </div>
        </div> 
