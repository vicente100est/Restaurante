...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <style type="text/css">
            .secondbg{ 
                ...
                top:0;
                width:100%;
                background-image: url('<?php echo ss_location . ss_background; ?>');
    ...
    <body class="hold-transition login-page secondbg">
        <div class="login-box">
            ...
            $today = date('Y-m-d');
            $start_date = ss_msg_start;
            $end_date = ss_msg_end; 

            if (($today >= $start_date) && ($today <= $end_date)) {
                echo '<h1 style="text-align: center; color: white; font-weight: bold; text-shadow: 0px 0px 10px #CE5937;">'. ss_msg .'</h1>';
            } 

            ?> 
            <div class="login-logo" style="border-radius: 5px; background-color: mediumpurple;"> 
                <a href="#"><img src="<?php echo ss_location . ss_login_page_logo; ?>"></a> 
            </div>  
            <?php
